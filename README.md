...
- **Settings**：配置特征提取项
- **Add to Class 1**：快速切换到前景目标标注
- **Add to Class 2**：快速切换到背景对象标注
...
1. 打开图像。
2. 右侧使用 **Add to Class 1** 为前景目标添加样本，使用 **Add to Class 2** 为背景对象添加样本。
3. 使用 `Paint` 工具在图像上为当前类别涂抹样本。
4. 如果你创建了更多类别，也可以从类别列表切换并继续标注。
